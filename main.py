...
strings = ['ba triệu năm trăm sáu mươi nghìn đồng',
...
# converted, label = clean_num('mười', embedding_model = word2vec_model, label_model = label_model)
...
for string in strings:
    ...
    converted, label = clean_num(string, embedding_model = word2vec_model, label_model = label_model)
    print('Label:\n',label,'\n')
